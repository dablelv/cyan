...
func TestHMACMd5(t *testing.T) {
	assert := utest.NewAssert(t, "HMACMd5")
...
func TestHMACSha1(t *testing.T) {
	assert := utest.NewAssert(t, "HMACSha1")
...
func TestHMACSha224(t *testing.T) {
	assert := utest.NewAssert(t, "HMACSha224")
...
func TestHMACSha256(t *testing.T) {
	assert := utest.NewAssert(t, "HMACSha256")
...
func TestHMACSha384(t *testing.T) {
	assert := utest.NewAssert(t, "HMACSha384")
...
func TestHMACSha512(t *testing.T) {
	assert := utest.NewAssert(t, "HMACSha512")
